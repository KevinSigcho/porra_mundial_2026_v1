      ...
      <div className="bracketSummary">
        <section className="standingCard qualifiedCardWide">
          <div className="standingHeader">
            ...
            <span className="qualificationHint">
              Primeros, segundos, mejores terceros y terceros eliminados
            </span>
          </div>
          <div className="qualifiedLists">
            ...
            <QualifiedList
              title="Mejores terceros clasificados"
...
function QualifiedList({
  ...
  return (
    <div
      className={`qualifiedList ${variant ? `qualifiedList-${variant}` : ""}`}
    >
      <h3>{title}</h3>
      {safeTeams.length === 0 ? (
        ...
        safeTeams.map((team) => (
          <div
            className={`qualifiedItem ${variant === "eliminated" ? "qualifiedItemEliminated" : ""}`}
            key={`${team.seed}-${team.team}`}
          >
